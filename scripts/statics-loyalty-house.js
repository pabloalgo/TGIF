...
const senatormissvotes = ["name", "total_votes", "votes_with_party_pct"];
...
function Topstaticsatendance(array) {
	...
	//console.log("HI I AM Real 10% Top", array[Toptenpercent].votes_with_party_pct	);
	let realtenpercent = array[Toptenpercent].votes_with_party_pct;
